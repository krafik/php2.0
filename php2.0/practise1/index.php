<?php
//1й способ
//require ('data.php'); //можно подключать файл несколько раз и более в проекте.
//2й способ
//require_once ('data.php'); //только один раз в проекте.
//3й способ
//include ('data.php'); // если файла нет, то фатальной ошибки нет. обычные будут.
    ...
    <div class="main-wrapper">
        ...
        <section class="section projects-section">
            ...
            <? foreach ($proj as $project) { ?>
                <div class="item">
                    <span class="project-title"><a href="#"><?= $project['name'] ?></a></span> - <span
                            class="project-tagline"><?= $project['decr'] ?></span>
                </div><!--//item-->
            <? } ?>
        </section><!--//section-->
